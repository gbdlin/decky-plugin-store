...
async def test_plugins_list_endpoint(
    ...
    expected_response = [
        ...
        },
        {
            ...
            "created": "2022-02-25T00:01:00",
            "updated": "2022-02-25T00:01:01",
            "versions": [
                {
                    "name": "2.0.0",
                    "hash": "56635138a27a6b0c57f0f06cdd58eadf58fff966516c38fca530e2d0f12a3190",
                    "created": "2022-02-25T00:01:01",
                },
                {
                    "name": "1.1.0",
        ...
        },
        {
            ...
            "created": "2022-02-25T00:05:00",
            "updated": "2022-02-25T00:05:01",
            "versions": [
                {
                    "name": "2.0.0",
                    "hash": "611a4f133a0e2f7ca4285478d4be7c6e09acc256c9f47d71a075d2af279d2c96",
                    "created": "2022-02-25T00:05:01",
                },
                {
                    "name": "1.1.0",
...
async def test_update_endpoint(
    ...
    resulting_versions_dates = (
        ["2022-04-04T00:00:00", "2022-04-04T00:00:00"]
        if override_versions
        else ["2022-02-25T00:00:02", "2022-02-25T00:00:01", "2022-02-25T00:00:00"]
        if pick_visible
        else ["2022-02-25T00:04:02", "2022-02-25T00:04:01", "2022-02-25T00:04:00"]
    )
    ...
    assert plugin.created.isoformat() == min(resulting_versions_dates)
    assert plugin.updated.isoformat() == max(resulting_versions_dates)
    ...
    for actual, expected in zip(
        ...
        assert actual.name == expected["name"]
        assert actual.hash == expected["hash"]
        assert actual.created.isoformat() == expected["created"]  # type:ignore[union-attr]
